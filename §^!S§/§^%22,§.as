package §^!S§
{
   ...
   public class §^",§ extends §super for static§ implements §=!t§
   {
      ...
      public function play(param1:int, param2:§for for native§) : Boolean
      {
         ...
         §%"^§.§true var throw§(this.trail,this.§get for package§,this.direction,param2.position);
         _loc4_ = this.time / this.§-!I§;
         _loc3_ = Math.sqrt(_loc4_);
         this.trail.scaleX = this.§="<§ + (this.§false for function§ - this.§="<§) * _loc3_;
