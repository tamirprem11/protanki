   ...
   public class BitmapAsset extends FlexBitmap implements IFlexAsset, IFlexDisplayObject, ILayoutDirectionElement
   {
      ...
      public function invalidateLayoutDirection() : void
      {
         ...
         while(_loc2_)
         {
            ...
            {
               _loc1_ = this._layoutDirection != null && ILayoutDirectionElement(_loc2_).layoutDirection != null && this._layoutDirection != ILayoutDirectionElement(_loc2_).layoutDirection;
