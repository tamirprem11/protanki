package com.hurlant.crypto.symmetric
{
   ...
   public class AESKey implements ISymmetricKey
   {
      ...
      (function():void
      {
         ...
         while(_loc1_ < 256)
         {
            Sbox[_loc1_] = _Sbox[_loc1_];
            InvSbox[_loc1_] = _InvSbox[_loc1_];
            Xtime2Sbox[_loc1_] = _Xtime2Sbox[_loc1_];
            Xtime3Sbox[_loc1_] = _Xtime3Sbox[_loc1_];
            Xtime2[_loc1_] = _Xtime2[_loc1_];
            Xtime9[_loc1_] = _Xtime9[_loc1_];
            XtimeB[_loc1_] = _XtimeB[_loc1_];
            XtimeD[_loc1_] = _XtimeD[_loc1_];
            XtimeE[_loc1_] = _XtimeE[_loc1_];
            _loc1_++;
         }
         Rcon = new ByteArray();
         _loc1_ = 0;
