package com.hurlant.util
{
   ...
   public class Base64
   {
      ...
      public static function encodeByteArray(param1:ByteArray) : String
      {
         ...
         while(_loc3_ < _loc5_)
         {
            _loc6_ = uint(param1[int(_loc3_++)] << 16 | param1[int(_loc3_++)] << 8 | param1[int(_loc3_++)]);
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ >>> 18)];
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ >>> 12 & 0x3F)];
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ >>> 6 & 0x3F)];
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ & 0x3F)];
         }
         if(_loc4_ == 1)
         {
            _loc6_ = uint(param1[int(_loc3_)]);
         ...
         {
            _loc6_ = uint(param1[int(_loc3_++)] << 8 | param1[int(_loc3_)]);
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ >>> 10)];
            _loc2_[int(_loc7_++)] = _encodeChars[int(_loc6_ >>> 4 & 0x3F)];
            _loc2_[int(_loc7_++)] = _encodeChars[int((_loc6_ & 0x0F) << 2)];
            _loc2_[int(_loc7_++)] = 61;
         }
         return _loc2_.readUTFBytes(_loc2_.length);
      }
