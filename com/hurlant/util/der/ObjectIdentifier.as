   ...
   public class ObjectIdentifier implements IAsn1Type
   {
      ...
      public function toDER() : ByteArray
      {
         ...
         while(_loc2_ < this.oid.length)
         {
            ...
            {
               _loc1_.push(_loc4_ >> 7 | 0x80);
               _loc1_.push(_loc4_ & 0x7F);
            }
            else if(_loc4_ < 128 * 128 * 128)
            {
               _loc1_.push(_loc4_ >> 14 | 0x80);
               _loc1_.push(_loc4_ >> 7 & 0x7F | 0x80);
               _loc1_.push(_loc4_ & 0x7F);
            }
            else
            {
               ...
               _loc1_.push(_loc4_ >> 21 | 0x80);
               _loc1_.push(_loc4_ >> 14 & 0x7F | 0x80);
               _loc1_.push(_loc4_ >> 7 & 0x7F | 0x80);
               _loc1_.push(_loc4_ & 0x7F);
            }
            _loc2_++;
