package §["]§
{
   ...
   public class TimeUnitService implements §;-§
   {
      [Inject]
      ...
      private static function §do implements§(param1:int, param2:int, param3:int) : TimeUnitNames
      {
         var _loc4_:TimeUnitNames = new TimeUnitNames();
         if(param3 == 1)
         {
         ...
         if(param2 == 1)
         {
            _loc4_.hourName = "hora";
         }
         else
         {
            _loc4_.hourName = "horas";
         }
         if(param1 == 1 || param1 == 0)
         {
            _loc4_.minuteName = "minuto";
         }
         else
         {
            _loc4_.minuteName = "minutos";
         }
         return _loc4_;
      }
      
      private static function §`i§(param1:int, param2:int, param3:int) : TimeUnitNames
      {
         var _loc4_:TimeUnitNames = new TimeUnitNames();
         if(param3 == 1)
         {
      ...
      private static function §="G§() : TimeUnitNames
      {
         var _loc1_:TimeUnitNames = new TimeUnitNames();
         _loc1_.dayName = "天";
         _loc1_.hourName = "小时";
         _loc1_.minuteName = "分鐘";
         return _loc1_;
      }
      
      private static function §override var import§(param1:int, param2:int, param3:int) : TimeUnitNames
      {
         var _loc4_:TimeUnitNames = new TimeUnitNames();
         if(param3 == 1)
         {
            _loc4_.dayName = "dzień";
         }
         else
         {
            _loc4_.dayName = "dni";
         ...
         if(param2 == 1)
         {
            _loc4_.hourName = "godzina";
         }
         else
         {
            _loc4_.hourName = "godzin";
         }
         if(param1 == 0)
         {
            _loc4_.minuteName = "minut";
         }
         else if(param1 == 1)
         {
            _loc4_.minuteName = "minuta";
         }
         else if(param1 >= 2 && param1 <= 4 || param1 >= 22 && param1 <= 24 || param1 >= 32 && param1 <= 34 || param1 >= 42 && param1 <= 44 || param1 >= 52 && param1 <= 54)
         {
            _loc4_.minuteName = "minuty";
         }
         else
         {
            _loc4_.minuteName = "minut";
      ...
      {
         var _loc4_:String = "";
         var _loc5_:TimeUnitNames = this.getTimeUnitNames(param1,param2,param3);
      ...
      public function getTimeUnitNames(param1:int, param2:int, param3:int) : TimeUnitNames
      {
         switch(localeService.language)
         {
            ...
            case "pt_BR":
               return §do implements§(param1,param2,param3);
            case "pl":
               return §override var import§(param1,param2,param3);
            case "es":
               return §`i§(param1,param2,param3);
            case "cn":
               return §="G§();
            case "en":
         }
