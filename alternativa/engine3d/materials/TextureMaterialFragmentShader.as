package alternativa.engine3d.materials
{
   ...
   public class TextureMaterialFragmentShader extends FragmentShader
   {
      public function TextureMaterialFragmentShader(param1:Boolean, param2:Boolean, param3:Boolean, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean, param9:Boolean, param10:Boolean, param11:Boolean, param12:Boolean, param13:Boolean, param14:Boolean, param15:Boolean, param16:Boolean, param17:Boolean, param18:Boolean, param19:Boolean)
      {
         var _loc20_:int = 0;
         super();
         var _loc21_:SamplerRepeat = param1 ? SamplerRepeat.WRAP : SamplerRepeat.CLAMP;
         var _loc22_:SamplerFilter = param2 ? SamplerFilter.LINEAR : SamplerFilter.NEAREST;
         var _loc23_:SamplerMipMap = param3 ? (param2 ? SamplerMipMap.LINEAR : SamplerMipMap.NEAREST) : SamplerMipMap.NONE;
         var _loc24_:SamplerType = param4 ? SamplerType.DXT1 : SamplerType.RGBA;
         tex(ft0,v0,fs0.dim(SamplerDim.D2).repeat(_loc21_).filter(_loc22_).mipmap(_loc23_).type(_loc24_));
         if(param6)
         {
            sub(ft1.w,ft0,fc[14]);
            kil(ft1.w);
         ...
         if(param16)
         {
            ...
            mul(ft2,ft1.z,ft1);
            _loc20_ = 0;
            while(_loc20_ < ShadowMap.numSamples)
            {
               if(_loc20_ == 0)
               {
                  add(ft1,ft2,v2);
