package alternativa.engine3d.loaders
{
   ...
   public class Parser3DS
   {
      ...
      private static const §catch var override§:int = 16720;
      ...
      private function §<#§(param1:ObjectData) : void
      {
      ...
      private function buildMesh(param1:Mesh, param2:ObjectData, param3:AnimationData, param4:Number) : void
      {
         ...
         {
            _loc11_ = new Face();
            _loc11_.alternativa3d::wrapper = new Wrapper();
         ...
         var _loc16_:FillMaterial = new FillMaterial(8355711);
         _loc16_.name = "default";
