package alternativa.math
{
   ...
   public class Matrix3
   {
      ...
      private static const §throw var continue§:Vector3 = new Vector3();
      
      private static const §=!D§:Vector3 = new Vector3();
      
      private static const §4"R§:Vector3 = new Vector3();
      ...
      public function §break var const§(param1:Vector3) : void
      {
         §=!D§.copy(param1).normalize();
         if(§=!D§.dot(Vector3.X_AXIS) < 0.9)
         {
            §4"R§.cross2(Vector3.X_AXIS,§=!D§);
         }
         else
         {
            §4"R§.cross2(§=!D§,Vector3.Y_AXIS);
         }
         §4"R§.normalize();
         §throw var continue§.cross2(§=!D§,§4"R§).normalize();
         this.§default var each§(§throw var continue§,§=!D§,§4"R§);
      }
      
      public function §default var each§(param1:Vector3, param2:Vector3, param3:Vector3) : void
      {
         this.m00 = param1.x;
         this.m01 = param2.x;
         this.m02 = param3.x;
