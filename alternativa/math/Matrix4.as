package alternativa.math
{
   ...
   public class Matrix4
   {
      ...
      public function §!f§(param1:Number, param2:Number, param3:Number, param4:Vector3) : void
      {
      ...
      public function transformVectors(param1:Vector.<Vector3>, param2:Vector.<Vector3>) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            _loc4_.x = this.m00 * _loc3_.x + this.m01 * _loc3_.y + this.m02 * _loc3_.z + this.m03;
      ...
      public function §in const else§(param1:Object3D) : void
      {
