package alternativa.math
{
   ...
   public class Quaternion
   {
      ...
      public function toMatrix3(param1:Matrix3) : Quaternion
      {
         ...
         var _loc9_:Number = 2 * this.y * this.z;
         _loc2_ = 2 * this.z * this.x;
         _loc3_ = 2 * this.w * this.x;
         _loc4_ = 2 * this.w * this.y;
         var _loc10_:Number = 2 * this.w * this.z;
         param1.m00 = 1 - _loc6_ - _loc7_;
         param1.m01 = _loc8_ - _loc10_;
         param1.m02 = _loc2_ + _loc4_;
         param1.m10 = _loc8_ + _loc10_;
         param1.m11 = 1 - _loc5_ - _loc7_;
         param1.m12 = _loc9_ - _loc3_;
         param1.m20 = _loc2_ - _loc4_;
         param1.m21 = _loc9_ + _loc3_;
         param1.m22 = 1 - _loc5_ - _loc6_;
         return this;
      }
      ...
      {
         var _loc2_:Number = NaN;
         var _loc3_:Number = 2 * this.x * this.x;
      ...
      public function getZAxis(param1:Vector3) : Vector3
      {
         var _loc2_:Number = NaN;
         var _loc3_:Number = 2 * this.x * this.x;
         var _loc4_:Number = 2 * this.y * this.y;
         var _loc5_:Number = 2 * this.y * this.z;
         var _loc6_:Number = 2 * this.z * this.x;
         _loc2_ = 2 * this.w * this.x;
         var _loc7_:Number = 2 * this.w * this.y;
         param1.x = _loc6_ + _loc7_;
         param1.y = _loc5_ - _loc2_;
         param1.z = 1 - _loc3_ - _loc4_;
         return param1;
      }
      ...
      public function toMatrix4(param1:Matrix4) : Quaternion
      {
         ...
         var _loc7_:Number = 2 * this.x * this.y;
         _loc4_ = 2 * this.y * this.z;
         var _loc8_:Number = 2 * this.z * this.x;
         _loc5_ = 2 * this.w * this.x;
         var _loc9_:Number = 2 * this.w * this.y;
         var _loc10_:Number = 2 * this.w * this.z;
         param1.m00 = 1 - _loc6_ - _loc3_;
         param1.m01 = _loc7_ - _loc10_;
         param1.m02 = _loc8_ + _loc9_;
         param1.m10 = _loc7_ + _loc10_;
         param1.m11 = 1 - _loc2_ - _loc3_;
         param1.m12 = _loc4_ - _loc5_;
         param1.m20 = _loc8_ - _loc9_;
         param1.m21 = _loc4_ + _loc5_;
         param1.m22 = 1 - _loc2_ - _loc6_;
         return this;
      }
