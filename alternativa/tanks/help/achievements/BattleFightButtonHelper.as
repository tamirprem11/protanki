package alternativa.tanks.help.achievements
{
   ...
   public class BattleFightButtonHelper extends BubbleHelper
   {
      public function BattleFightButtonHelper()
      {
         ...
         text = _loc1_.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_FIRST_BATTLE_BUTTON_TEXT);
         arrowLehgth = int(_loc1_.getText(TanksLocale.TEXT_HELP_PANEL_ACHIEVEMENTS_FIRST_BATTLE_BUTTON_ARROW_LENGTH));
