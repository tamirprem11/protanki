package alternativa.tanks.model.shop
{
   ...
   public class ShopCategorysView extends Sprite
   {
      ...
      {
         var _loc3_:ShopCategoryView = null;
         _loc3_ = null;
         this._width = param1;
         this._height = param2;
         ...
         var _loc4_:int = -12;
         for each(_loc3_ in this.categoriesPosition)
         {
            _loc3_.x = AROUND_GAP;
            _loc3_.render(this._width - AROUND_GAP * 2 - (this.scrollPane.verticalScrollBar.width - SCROLL_SHIFT_GAP - 1));
            _loc3_.y = _loc4_ + VERTICAL_GAP;
