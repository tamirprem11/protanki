package alternativa.tanks.controllers.battleinfo
{
   ...
   public class BattleInfoTeamController extends EventDispatcher implements IImageResource
   {
      ...
      private var _rememberBattleTeam:§while var const§;
      ...
      private function showPayedBattleAlert(param1:§while var const§) : void
      {
         this._rememberBattleTeam = param1;
         var _loc2_:Vector.<String> = Vector.<String>([§if const finally§.ENTER,§if const finally§.§-!"§]);
         battleAlertService.showAlert(localeService.getText(TanksLocale.§"!%§),_loc2_);
