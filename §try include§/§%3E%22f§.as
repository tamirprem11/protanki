package §try include§
{
   ...
   public class §>"f§
   {
      ...
      private var §override for include§:Long = Long.getLong(1744513692,181388452);
      ...
      private var §else const break§:Long = Long.getLong(430590662,-88054305);
      
      private var §try finally§:ICodec;
      
      private var §"!x§:Long = Long.getLong(625603135,-1078364647);
      ...
      public function §>"f§(param1:IModel)
      {
         super();
         this.model = param1;
